...
CampoValorDocumentoPortal Documental Permanente da FESTANÇACaminho oficialdocs/festanca/README.mdClassificaçãoDocumento constitucional de entradaDomínioPortal Permanente da FESTANÇARegimePermanenteCriticidadeAltaMutabilidadeControladaPreservaçãoIntegral e versionadaEdição fundadoraFESTANÇA 2026SituaçãoFundação documental permanenteVersão inicial1.0.0
...
RegimeDefiniçãoPermanenteIntegra duradouramente a arquiteturaAnualPertence exclusivamente a uma ediçãoCompartilhadoUtilizado por várias ediçõesOperacionalNecessário à execução correnteTransitórioCriado para diagnóstico ou migraçãoHistóricoPreservado como evidênciaImutávelNão pode ser alterado após emissãoEvolutivoPode ser aperfeiçoado sob controleSubstituídoInativo, mas rastreávelDescontinuadoRetirado mediante decisão formalÓrfãoSem função comprovadaPendenteAguarda classificação
...
a FESTANÇA possui arquitetura documental permanente;


a edição de 2026 é a edição fundadora;


futuras edições deverão preservar a continuidade histórica;


a documentação permanente prevalecerá sobre práticas informais;


nenhuma evolução técnica justificará perda de memória;


toda edição deverá ser identificável, recuperável e auditável;


a tecnologia será instrumento de preservação cultural;


o acervo será tratado como patrimônio institucional e histórico.
